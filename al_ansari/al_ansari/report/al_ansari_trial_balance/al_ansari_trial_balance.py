...
from al_ansari.al_ansari.report.financial_statements import (
	filter_accounts,
...
def prepare_data(accounts, filters, total_row, parent_children_map, company_currency):
	...
	for d in accounts:
		# print(d)
		print(d)
		company_name = frappe.get_value("Account", d.name, "company")
		cost_center_list = frappe.get_all("Cost Center", filters={"company": company_name, "is_group": 0} )
